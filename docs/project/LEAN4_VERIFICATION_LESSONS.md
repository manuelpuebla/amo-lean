...
1. **Búsqueda por problema**: Cada lección tiene un título descriptivo del problema que resuelve
2. **Código ejemplo**: Todas las lecciones incluyen código Lean 4 funcional
3. **Contexto real**: Las lecciones vienen de casos reales, no abstractos
4. **Progresión**: Las lecciones están ordenadas por complejidad creciente
