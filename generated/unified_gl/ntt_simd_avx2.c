 ...
 * Mode: AmoLean.EGraph.Verified.Bitwise.UnifiedCodeGen.ExecMode.scalar (from isSimd=true, lanes=8)
 * Reduction: AmoLean.EGraph.Verified.Bitwise.UnifiedCodeGen.ReductionStrategy.solinasFold (from wideningPenalty=8)
...
void ntt_simd_avx2(uint64_t *data, size_t n, const uint64_t *twiddles) {
