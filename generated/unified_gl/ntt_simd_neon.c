 ...
 * Mode: AmoLean.EGraph.Verified.Bitwise.UnifiedCodeGen.ExecMode.scalar (from isSimd=true, lanes=4)
...
void ntt_simd_neon(uint64_t *data, size_t n, const uint64_t *twiddles) {
